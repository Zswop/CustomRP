...
namespace OpenCS
{
    ...
    {		
		...
		public static NoiseSample Perlin2D(Vector3 point, float frequency)
		{
			...
			//Mathf.Lerp(Mathf.Lerp(v00, v10, tx),
		...
		public static NoiseSample Sum(NoiseMethod method, Vector3 point, float frequency, int octaves, 
			float lacunarity /* frequency */, float persistence /* amplitude */)
		{
