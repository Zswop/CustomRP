    ...
    public class Shadows
    {
        ...
        public void Render()
        {
            ...
            buffer.SetGlobalInt(cascadeCountId, shadowedDirLightCount > 0 ? 
                (int)settings.directional.cascadeCount : 0);
        ...
        void RenderDirectionalShadows()
        {
            ...
            int tiles = shadowedDirLightCount * (int)settings.directional.cascadeCount;
        ...
        void RenderOtherShadows()
        {
            ...
            {
                bool isPoint = shadowedOtherLights[i].isPoint;
                if (isPoint) { RenderPointShadows(i, split, tileSize); i += 6; }
                else { RenderSpotShadows(i, split, tileSize); i += 1; }
            }
        ...
        void SetKeywords(string[] keywords, int enabledIndex)
        {
            ...
            {
                if (i == enabledIndex) { buffer.EnableShaderKeyword(keywords[i]); }
